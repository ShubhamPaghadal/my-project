...
function Drop_down() {
  console.log("get_product...", get_category);
  ...
  return (
    <>
      ...
      <div className="  max-w-[1440px]  m-[auto] flex flex-wrap  justify-center gap-12  mt-[151px] ">
        <div
          className="  border-b-4  flex-col justify-between
        ...
        >
          <div>
            ...
            <div>
              ...
              <p className="text-base text-[#666] mb-2.5">
                {get_product.category}
              </p>
              <p className="text-[#8d8b8b] mb-2.5 text-sm">
                {get_product.rating?.rate}
              </p>
            </div>
