...
function App() {
  ...
  const filter_ittems =  product.filter((item) => item.title.toLowerCase().includes( query))
  ...
  return (
    ...
    <Routes>
        ...
        {setquery}/>} >
          ...
          <Route path='/'  element={<Home loading={loading}  add_wishlist_cart={add_wishlist_cart} 
          add_cart={add_cart} add_wishlist={add_wishlist} add_item={add_item} 
          product={filter_ittems} setadd_item={setadd_item}
          ...
          <Route path='/toggle'  element={<Toggle_item add_item={add_item}/>}  />

          <Route path='/wishlist'  element={<Wishlist add_wishlist={add_wishlist}/>}  />
